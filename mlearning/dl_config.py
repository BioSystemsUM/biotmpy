...
class DLConfig:
    ...
    def create_model_folder(self):
        if not os.path.exists('models'):
            os.mkdir('models')
        directory = Path('../pipelines/models/' + self.model_name)
        if not os.path.exists(directory):
            os.mkdir(directory)

    def set_model_id(self):
        output_path = Path('../pipelines/models/' + self.model_name + '/' + 'results_'+ self.model_name + '.xlsx')
        ...
        self.model_id_path = Path('../pipelines/models/' + self.model_name + '/' + self.model_id)
