...
class DLConfig:
    ...
    def write_report(self):
        ...
        if not os.path.exists('../examples_pipelines/models/' + self.model_name):
            os.mkdir('../examples_pipelines/models/' + self.model_name)
        excel_path = Path('../examples_pipelines/models/' + self.model_name + '/' + 'results_' + self.model_name + '.xlsx')
