...
def pmc_to_list(term): 
    ...
    url = f'https://www.ebi.ac.uk/europepmc/webservices/rest/search?query=EXT_ID:("PMC")%20AND%20(TITLE:"{term}" OR ABSTRACT:"{term}")&pageSize=1000&resultType=core&format=json' 
...
def get_annotations(paper_instance): 
    ...
    #annotations_url= f'https://www.ebi.ac.uk/europepmc/annotations_api/annotationsByArticleIds?articleIds=PMC%3A36419223&pageSize=1000&type=Organisms%2CGene_Proteins%2CDiseases%2CChemicals'
