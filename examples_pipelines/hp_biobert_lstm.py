model_name = 'hp_static_biobert_lstm'
...
from src.biotmpy.mlearning.dl_models import Hierarchical_Attention_GRU, Hierarchical_Attention_LSTM, \
    Hierarchical_Attention_LSTM2, Hierarchical_Attention_LSTM3
...
def Static_Biobert_LSTM_Hyper(hp):
    ...
    ## fine-tuning
    x = Bidirectional(LSTM(hp.Choice('lstm_units', values=[64, 128, 256], default=128), return_sequences=True))(
        embedding)
...
tuner.search(x_train, y_train, epochs=11, batch_size=32, validation_data=(x_val, y_val))
