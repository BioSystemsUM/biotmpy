...
from src.biotmpy.mlearning.dl_models import Burns_CNN, Burns_LSTM, Chollet_DNN, DNN, Burns_CNN2, Burns_BiLSTM, \
    Burns_CNN3, Burns_CNNBiLSTM
from src.biotmpy.mlearning.dl_models import Hierarchical_Attention, Hierarchical_Attention_v2, DeepDTA
from src.biotmpy.mlearning import compute_embedding_matrix, glove_embeddings_2
from src.biotmpy.mlearning.ml import serialize_config, deserialize_config
import numpy as np
...
x_train_title, x_train_abstract, y_train, x_val_title, x_val_abstract, y_val = DL_preprocessing(x_train, y_train,
                                                                                                config, set='train',
...
# model = Hierarchical_Attention(embedding_matrix, config, seed_value=seed_value)
# model = Hierarchical_Attention_v2(embedding_matrix, config, seed_value=seed_value)
# model = Burns_CNNBiLSTM(embedding_matrix, config, seed_value=seed_value)
# model = Burns_CNN(embedding_matrix, config, seed_value=seed_value)
model = DeepDTA(embedding_matrix, config)
...
# x_test, y_test = DL_preprocessing(x_test, y_test, config, set = 'test', padding=padding, truncating=truncating)

x_test_title, x_test_abstract, y_test = DL_preprocessing(x_test, y_test, config, set='test', padding=padding,
                                                         truncating=truncating, model='DeepDTA')
...
# save parameters
d = {'Model': [], 'Emb': [], 'Emb_Dim': [], 'Learning_rate': [], 'train_acc': [], 'train_f1': [], 'test_acc': [],
     'test_prec': [], 'test_recall': [], 'test_f1': [],
     'roc_auc': [], 'TP': [], 'TN': [], 'FP': [], 'FN': [], 'epochs': [], 'batch_size': [], 'stop_words': [],
     'lower': [], 'remove_punc': [],
     'max_sent_len': [], 'max_nb_words': [], 'max_nb_sentences': [], 'oov_token': [], 'val_percentage': [],
     'split_by_hypen': [], 'seed_value': [],
     'history_acc': [], 'history_loss': [], 'history_f1': [], 'history_val_acc': [], 'history_val_loss': [],
     'history_val_f1': [], 'lemmatization': [],
