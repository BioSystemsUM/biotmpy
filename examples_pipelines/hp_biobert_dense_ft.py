model_name = 'hp_non_static_biobert_dense'
...
def Non_Static_Biobert_Dense_Hyper(hp):
    ...
    X = bert_model([idx, masks, segments])[0]
    ...
    learning_rate = hp.Choice('learning_rate', [2e-5, 3e-5, 5e-5], default=5e-5)
...
tuner = Hyperband(
    Non_Static_Biobert_Dense_Hyper,
    max_epochs=5,
